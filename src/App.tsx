...
function App() {
  ...
  return (
    <div className="min-h-screen selection:bg-red-500/30 font-sans">
      ...
      <nav className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[95%] md:w-[90%] max-w-5xl">
        <div className="glass rounded-full px-4 md:px-6 py-2 flex justify-between items-center border border-white/10">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            {/* SELECTOR DE IDIOMA EN EL HEADER - ES, EN, PT, IT */}
      ...
      {/* ========== PERFIL Y TRAYECTORIA CON IMAGEN DE CONFERENCIA 2 (MÁS PEQUEÑA) ========== */}
            ...
            <div>
              <div className="flex justify-center mb-8">
                <div className="relative">
                  {/* IMAGEN MÁS PEQUEÑA - max-w-sm */}
                  <div className="w-full max-w-sm rounded-2xl overflow-hidden border-2 border-red-500/30 ring-2 ring-white/10 shadow-2xl mx-auto">
                    <img 
      ...
      <section id="services" className="py-24 relative z-10 bg-[#050505] border-t border-white/5">
        <div className="container mx-auto max-w-6xl px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[180px]">
            ...
            {/* SECCIÓN GLOBAL REACH - AHORA SOLO EL TÍTULO (EL SELECTOR ESTÁ EN EL HEADER) */}
            <motion.div 
              initial={{ opacity: 0, scale: 0.95 }}
              animate={{ opacity: 1, scale: 1 }}
